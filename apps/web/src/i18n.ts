...
const pl: Record<string, string> = {
  ...
  'Pay someone': 'Zapłać komuś',
  'Take a payment': 'Przyjmij płatność',
  'How does NIMble work?': 'Jak działa NIMble?',
  "Receiver doesn't have NIMble yet? Send them a link": 'Odbiorca nie ma jeszcze NIMble? Wyślij mu link',
  'Recommend NIMble': 'Poleć NIMble',
  ...
  'e.g. 2.5': 'np. 2,5',
  'e.g. Soda': 'np. Napój',
  'Add a product or enter an amount to continue': 'Dodaj produkt lub wpisz kwotę, aby przejść dalej',
  'Enter an amount to create the bill': 'Wpisz kwotę, aby utworzyć rachunek',
  'Enter a name and a price': 'Wpisz nazwę i cenę',
  '✓ Copied': '✓ Skopiowano',
  'This PIN locks this app. It does not protect your NIM in Nimiq Pay.': 'Ten PIN blokuje tę aplikację. Nie chroni Twoich NIM w Nimiq Pay.',
  ...
  'Add a custom amount (USD)': 'Dodaj własną kwotę (USD)',
  'Take NIM': 'Przyjmij NIM',
  'Cash': 'Gotówka',
  'cash': 'gotówka',
  'Cash to settle': 'Gotówka do rozliczenia',
  '{n} transactions': '{n} transakcji',
  'Recorded.': 'Zapisano.',
  ...
  'On the till': 'Na kasie',
  'No sales yet — takings will appear here.': 'Brak sprzedaży — utarg pojawi się tutaj.',
  'Cash sale': 'Sprzedaż gotówkowa',
  'Export': 'Eksport',
  'Export CSV': 'Eksport CSV',
  'Export JSON': 'Eksport JSON',
  "Closing {name}'s shift": 'Zamykasz zmianę: {name}',
  'Keep it open': 'Zostaw otwartą',
  'Shifts': 'Zmiany',
  'No closed shifts yet.': 'Brak zamkniętych zmian.',
  'Filters': 'Filtry',
  'any date': 'dowolna data',
  'today': 'dzisiaj',
...
const de: Record<string, string> = {
  ...
  'Pay someone': 'Jemandem bezahlen',
  'Take a payment': 'Zahlung annehmen',
  'How does NIMble work?': 'Wie funktioniert NIMble?',
  "Receiver doesn't have NIMble yet? Send them a link": 'Empfänger hat NIMble noch nicht? Schick einen Link',
  'Recommend NIMble': 'NIMble weiterempfehlen',
  ...
  'e.g. 2.50': 'z. B. 2,50',
  'e.g. 2.5': 'z. B. 2,5',
  'e.g. Soda': 'z. B. Limonade',
  'Add a product or enter an amount to continue': 'Produkt hinzufügen oder Betrag eingeben, um fortzufahren',
  'Enter an amount to create the bill': 'Betrag eingeben, um die Rechnung zu erstellen',
  'Enter a name and a price': 'Name und Preis eingeben',
  '✓ Copied': '✓ Kopiert',
  'This PIN locks this app. It does not protect your NIM in Nimiq Pay.': 'Diese PIN sperrt diese App. Sie schützt deine NIM in Nimiq Pay nicht.',
  ...
  'Add a custom amount (USD)': 'Eigenen Betrag hinzufügen (USD)',
  'Take NIM': 'NIM annehmen',
  'Cash': 'Bargeld',
  'cash': 'bar',
  'Cash to settle': 'Bargeld zum Abrechnen',
  ...
  'On the till': 'An der Kasse',
  'No sales yet — takings will appear here.': 'Noch keine Verkäufe — Einnahmen erscheinen hier.',
  'Cash sale': 'Barverkauf',
  'Export': 'Export',
  'Export CSV': 'CSV exportieren',
  'Export JSON': 'JSON exportieren',
  "Closing {name}'s shift": 'Schicht von {name} schließen',
  'Keep it open': 'Offen lassen',
  'Shifts': 'Schichten',
  'No closed shifts yet.': 'Noch keine geschlossenen Schichten.',
  'Filters': 'Filter',
...
const es: Record<string, string> = {
  ...
  'Pay someone': 'Pagar a alguien',
  'Take a payment': 'Cobrar un pago',
  'How does NIMble work?': '¿Cómo funciona NIMble?',
  "Receiver doesn't have NIMble yet? Send them a link": '¿El receptor aún no tiene NIMble? Envíale un enlace',
  'Recommend NIMble': 'Recomendar NIMble',
  ...
  'e.g. 2.50': 'p. ej. 2,50',
  'e.g. 2.5': 'p. ej. 2,5',
  'e.g. Soda': 'p. ej. Refresco',
  'Add a product or enter an amount to continue': 'Añade un producto o introduce un importe para continuar',
  'Enter an amount to create the bill': 'Introduce un importe para crear la factura',
  'Enter a name and a price': 'Introduce un nombre y un precio',
  '✓ Copied': '✓ Copiado',
  'This PIN locks this app. It does not protect your NIM in Nimiq Pay.': 'Este PIN bloquea esta aplicación. No protege tus NIM en Nimiq Pay.',
  ...
  'Add a custom amount (USD)': 'Añadir un importe personalizado (USD)',
  'Take NIM': 'Aceptar NIM',
  'Cash': 'Efectivo',
  'cash': 'efectivo',
  'Cash to settle': 'Efectivo a liquidar',
  ...
  'On the till': 'En la caja',
  'No sales yet — takings will appear here.': 'Aún no hay ventas: la recaudación aparecerá aquí.',
  'Cash sale': 'Venta en efectivo',
  'Export': 'Exportar',
  'Export CSV': 'Exportar CSV',
  'Export JSON': 'Exportar JSON',
  "Closing {name}'s shift": 'Cerrando el turno de {name}',
  'Keep it open': 'Dejarlo abierto',
  'Shifts': 'Turnos',
  'No closed shifts yet.': 'Aún no hay turnos cerrados.',
  'Filters': 'Filtros',
...
const fr: Record<string, string> = {
  ...
  'Take a payment': 'Accepter un paiement',
  'How does NIMble work?': 'Comment fonctionne NIMble ?',
  "Receiver doesn't have NIMble yet? Send them a link": "Le destinataire n'a pas encore NIMble ? Envoyez-lui un lien",
  'Recommend NIMble': 'Recommander NIMble',
  ...
  'e.g. 2.5': 'ex. 2,5',
  'e.g. Soda': 'ex. Soda',
  'Add a product or enter an amount to continue': 'Ajoutez un produit ou saisissez un montant pour continuer',
  'Enter an amount to create the bill': 'Saisissez un montant pour créer la note',
  'Enter a name and a price': 'Saisissez un nom et un prix',
  '✓ Copied': '✓ Copié',
  'This PIN locks this app. It does not protect your NIM in Nimiq Pay.': 'Ce code PIN verrouille cette application. Il ne protège pas vos NIM dans Nimiq Pay.',
  ...
  'Add a custom amount (USD)': 'Ajouter un montant personnalisé (USD)',
  'Take NIM': 'Accepter en NIM',
  'Cash': 'Espèces',
  'cash': 'espèces',
  'Cash to settle': 'Espèces à remettre',
  ...
  'On the till': "En caisse",
  'No sales yet — takings will appear here.': "Aucune vente pour l'instant — les recettes apparaîtront ici.",
  'Cash sale': "Vente en espèces",
  'Export': "Exporter",
  'Export CSV': "Exporter en CSV",
  'Export JSON': "Exporter en JSON",
  "Closing {name}'s shift": "Fermeture du poste de {name}",
  'Keep it open': "Le laisser ouvert",
  'Shifts': "Services",
  'No closed shifts yet.': "Aucun service fermé pour l'instant.",
  'Filters': "Filtres",
...
const pt: Record<string, string> = {
  ...
  'Pay someone': 'Pagar a alguém',
  'Take a payment': 'Receber um pagamento',
  'How does NIMble work?': 'Como funciona o NIMble?',
  "Receiver doesn't have NIMble yet? Send them a link": 'O destinatário ainda não tem NIMble? Envie um link',
  'Recommend NIMble': 'Recomendar NIMble',
  ...
  'e.g. 2.50': 'ex.: 2,50',
  'e.g. 2.5': 'ex.: 2,5',
  'e.g. Soda': 'ex.: Refrigerante',
  'Add a product or enter an amount to continue': 'Adicione um produto ou introduza um valor para continuar',
  'Enter an amount to create the bill': 'Introduza um valor para criar a conta',
  'Enter a name and a price': 'Introduza um nome e um preço',
  '✓ Copied': '✓ Copiado',
  'This PIN locks this app. It does not protect your NIM in Nimiq Pay.': 'Este PIN bloqueia esta aplicação. Não protege os seus NIM na Nimiq Pay.',
  ...
  'Add a custom amount (USD)': 'Adicionar um valor personalizado (USD)',
  'Take NIM': 'Aceitar NIM',
  'Cash': 'Dinheiro',
  'cash': 'dinheiro',
  'Cash to settle': 'Dinheiro a acertar',
  ...
  'On the till': 'No caixa',
  'No sales yet — takings will appear here.': 'Ainda não há vendas — a receita aparecerá aqui.',
  'Cash sale': 'Venda em dinheiro',
  'Export': 'Exportar',
  'Export CSV': 'Exportar CSV',
  'Export JSON': 'Exportar JSON',
  "Closing {name}'s shift": 'Fechando o turno de {name}',
  'Keep it open': 'Deixar aberto',
  'Shifts': 'Turnos',
  'No closed shifts yet.': 'Ainda não há turnos fechados.',
  'Filters': 'Filtros',
